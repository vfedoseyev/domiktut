...
<head>
    ...
    <title>Аренда коттеджей и домов в городе Казань</title>
    <meta name="mailru-domain" content="k71vfgG0r1KX0MlR" />
</head>
...
<body>
    ...
    <div class="background-block-home">
        <div class="header-white-scroll">
            <nav class="nav-light-scroll">
                ...
                <div class="nav__section tablet-hidden">
                    <a class="nav__item nav__item-light" href="#faq">Частые вопросы</a>
                    <a class="nav__item nav__item-light" href="#cooperation">Сотрудничество</a>
                </div>
                <div class="nav__section">
                    ...
                    <a href="<?php the_permalink(3523); ?>" class="favorites mobile-hidden" class="nav__item mobile-hidden">
        ...
        <header class="header">
            <nav class="nav">
                <div class="nav__section">
                    <a href="https://domiktut.ru/" class="logo">
                    </a>
                    <div class="geo tablet-hidden">
                        <img src="<?php bloginfo('template_url'); ?>/images/svg/geo.svg" alt="">
                    ...
                    <a href="<?php echo get_category_link($_COOKIE["selected_city"]) ?>" class="nav__btn mobile-hidden">Каталог</a>
                </div>
                <div class="nav__section tablet-hidden">
                    <a class="nav__item" href="#faq">Частые вопросы</a>
                    <a class="nav__item" href="#cooperation">Сотрудничество</a>
                </div>
                <div class="nav__section">
                    <div class="nav__item" id="tel">
                        <div class="tel tel-ico">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.5004 11.6833C15.5002 11.6833 15.5 11.6835 15.5 11.6838V14.63C15.5001 14.841 15.4202 15.0441 15.2763 15.1985C15.1325 15.3528 14.9355 15.4469 14.725 15.4617C14.3608 15.4867 14.0633 15.5 13.8333 15.5C6.46917 15.5 0.5 9.53083 0.5 2.16667C0.5 1.93667 0.5125 1.63917 0.538333 1.275C0.553102 1.06454 0.647151 0.867509 0.801503 0.723674C0.955855 0.579839 1.15902 0.499905 1.37 0.5H4.31667C4.42003 0.499896 4.51975 0.538216 4.59644 0.607517C4.67313 0.676818 4.72133 0.772152 4.73167 0.875C4.75083 1.06667 4.76833 1.21917 4.785 1.335C4.95061 2.49077 5.29 3.61486 5.79167 4.66917C5.87083 4.83583 5.81917 5.035 5.66917 5.14167L5.18105 5.49045C4.41614 6.03702 4.11879 7.05445 4.61299 7.8542C5.50046 9.29038 6.71079 10.5007 8.147 11.3881C8.94661 11.8821 9.96382 11.585 10.5105 10.8204L10.8575 10.335C10.91 10.2617 10.9865 10.2091 11.0737 10.1864C11.161 10.1637 11.2535 10.1723 11.335 10.2108C12.3892 10.7116 13.513 11.0501 14.6683 11.215C14.7842 11.2317 14.9367 11.25 15.1267 11.2683C15.2294 11.2789 15.3245 11.3271 15.3936 11.4038C15.4627 11.4804 15.5009 11.5798 15.5008 11.6829C15.5008 11.6831 15.5006 11.6833 15.5004 11.6833Z" />
                            </svg>
                        </div>
                    ...
                    <button id="search" class="search nav__item">
                        <div class="search-ico">
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.031 14.617L20.314 18.899L18.899 20.314L14.617 16.031C13.0237 17.3082 11.042 18.0029 9 18C4.032 18 0 13.968 0 9C0 4.032 4.032 0 9 0C13.968 0 18 4.032 18 9C18.0029 11.042 17.3082 13.0237 16.031 14.617ZM14.025 13.875C15.2941 12.5699 16.0029 10.8204 16 9C16 5.132 12.867 2 9 2C5.132 2 2 5.132 2 9C2 12.867 5.132 16 9 16C10.8204 16.0029 12.5699 15.2941 13.875 14.025L14.025 13.875Z" />
                            </svg>
        ...
        <div class="container">
            <div class="home">
                <div class="home__title">
                    <h1>Аренда коттеджей и домов в <span class="city-name">Казани</span></h1>
                    <h5 class="tablet-hidden">Найдите идеальный вариант сами или предоставьте это нам</h5>
                    <h5 class="hidden">Давайте вам что-нибудь подберём</h5>
                    <button class="home__btn btn-orange hidden call_request-btn">Заявка на подбор</button>
                    <div class="selections slider mobile-small-hidden">
                        <div class="selection__card">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/c бассейном.png" alt=""></a>
                            <p class="selections__title">С бассейном</p>
                        </div>
                        <div class="selection__card">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/семейные.png" alt=""></a>
                            <p class="selections__title">Семейные и уютные</p>
                        </div>
                        <div class="selection__card">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/хиты продаж.png" alt=""></a>
                            <p class="selections__title">Хиты продаж</p>
                        </div>
                        <div class="selection__card">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/под свадьбы.png" alt=""></a>
                            <p class="selections__title">Под свадьбы и корпоративы</p>
                        </div>
                        <div class="selection__card">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/с баней на дровах.png" alt=""></a>
                            <p class="selections__title">С русской баней</p>
                        </div>
                    </div>
                    <div class="main__links tablet-hidden">
                        <div class="links">
                ...
                <!-- <form action="" class="main-form tablet-hidden">

                    <div class="time">
                        <div>
                            <p class="main-form-description">Въезд</p>
                            <input type="date" name="" id="">
                        </div>

                        <div class="time__center-line"></div>
                        <div>
                            <p class="main-form-description">Отъезд</p>
                            <input type="date" name="" id="">
                        </div>
                    </div>

                    <div class="main-form-title">
                        <p class="main-form-description">Количество человек</p>
                        <input type="text" name="" id="">
                    </div>
                    <button type="submit" class="main-form-btn">Найти</button>
                </form> -->
    ...
    <main class="main">
        <div class="background-block-about">
            <div class="container">
                <div class="about">
                    <h3>О нас</h3>
                    <div class="about__cards content">
                        <div class="about__card">
                            <img src="<?php bloginfo('template_url'); ?>/images/svg/plane.svg" alt="">
                            <p class="about__description">Работаем с юридическими и физическими лицами</p>
                        </div>
                        <div class="about__card">
                            <img src="<?php bloginfo('template_url'); ?>/images/svg/phones.svg" alt="">
                            <p class="about__description">Бесплатный подбор, честные консультации и открытость к сотрудничеству
                            </p>
                        </div>
                        <div class="about__card">
                            <img src="<?php bloginfo('template_url'); ?>/images/svg/reputation.svg" alt="">
                            <p class="about__description">Работаем с 2014 года. Консультируем 30-80 человек в сутки, заселяем от 3 до 5 компаний в день. Помогли более 21 000 клиентам</p>
                        </div>
                        <div class="about__card">
                            <img src="<?php bloginfo('template_url'); ?>/images/svg/star.svg" alt="">
                            <p class="about__description">Средний рейтинг компании 4,5 из 5 (Avito, Google, Отзовик)</p>
                        </div>
                    </div>
                </div>
                <div class="selections-mobile small-visible">
                    <h3>Подборки</h3>
                    <div class="selections__cards-mobile content">
                        <div class="selection__card-mobile ">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/c бассейном.png" alt=""></a>
                            <p class="selections__title-mobile">С бассейном</p>
                        </div>
                        <div class="selection__card-mobile">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/семейные.png" alt=""></a>
                            <p class="selections__title-mobile">Семейные и уютные</p>
                        </div>
                        <div class="selection__card-mobile">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/хиты продаж.png" alt=""></a>
                            <p class="selections__title-mobile">Хиты продаж</p>
                        </div>
                        <div class="selection__card-mobile">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/под свадьбы.png" alt=""></a>
                            <p class="selections__title-mobile">Под свадьбы и корпоративы</p>
                        </div>
                        <div class="selection__card-mobile">
                            <a href=""><img src="<?php bloginfo('template_url'); ?>/images/selections/с баней на дровах.png" alt=""></a>
                            <p class="selections__title-mobile">С русской баней</p>
                        </div>
                    </div>
                </div>
                <div class="popular">
                    <h3>Популярное в каталоге</h3>
                    <div class="popular__cards content">
                        <?php
                        $args = [
                            'meta_query' => [
                                [
                                    'meta_key'        => 'popular-card',
                                    'meta_value'    => 'true'
                        ...
                        $myMap = [];
                        $myposts = new WP_Query(['numberposts' => '6', 'post_type'   => 'post', 'cat' => [$city], 'meta_key' => 'popular-card', 'meta_value' => true]);
                        //var_dump($myposts);
                        if ($myposts->have_posts()) {
                            ...
                            while ($myposts->have_posts()) {
                                ...
                                get_template_part('template-parts/content-card-popular', get_post_type());
                            }
                        } else {
                        }
                        wp_reset_postdata();
                    ...
                    <div class="popular__btn">
                        <a href="<?php echo get_category_link($_COOKIE["selected_city"]) ?>" class="btn-orange btn-orange_popular">Перейти в каталог</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="background-block-services">
            <div class="container">
                <div class="catering">
                    <h3>Можем организовать для Вас</h3>
                    <div class="catering__cards content">
                        <div class="catering__item  ">
                            <div class="catering__card card">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/buffet.svg" alt="">
                                <p class="catering__description">Кейтеринг</p>
                            </div>
                        </div>
                        <div class="catering__item ">
                            <div class="catering__card card ">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/chef.svg" alt="">
                                <p class="catering__description">Выездной повар</p>
                            </div>
                        </div>
                        <div class="catering__item ">
                            <div class="catering__card card ">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/cocktail.svg" alt="">
                                <p class="catering__description">Фуршет</p>
                            </div>
                        </div>
                        <div class="catering__item ">
                            <div class="catering__card card ">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/confetti.svg" alt="">
                                <p class="catering__description">Шоу программа</p>
                            </div>
                        </div>
                        <div class="catering__item ">
                            <div class="catering__card card ">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/bus.svg" alt="">
                                <p class="catering__description">Трансфер</p>
                            </div>
                        </div>
                        <div class="catering__item ">
                            <div class="catering__card card">
                                <img src="<?php bloginfo('template_url'); ?>/images/svg/microphone.svg" alt="">
                                <p class="catering__description">Мероприятия под ключ</p>
                            </div>
                        </div>
                    </div>
                    <div class="catering__btn">
                        <button class="btn-orange btn-orange_catering">Узнать подробнее</button>
                    </div>
                </div>
                <div class="faq">
                    <a href="" name="faq"></a>
                    ...
                    <div class="faq__questions one">
                        <div class="faq__item">
                            ...
                            <div class="answer">Бронирование происходит после внесения предоплаты 50% от суммы аренды, предварительно можно приезать на осмотр дома или провести онлайн показ (при наличии такой возможности).
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                                Какая сумма предоплаты нужна?
                            </div>
                            <div class="answer">Стандарт предоплаты 50% от суммы аренды, если сумма аренды большая, то можно уменьшить предоплату до 30%.
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                            ...
                            <div class="answer">Можно, по возможности можно сделать все. В каждом случае нужно общаться индивидуально как с клиентом, так и с собственником.

                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                                Как работаете с юр.лицами?
                            </div>
                            <div class="answer">У нас открыто ИП и мы можем предложить заключить с нами агентский договор, на основании которого мы забронируем за Вами коттедж и пример оплату за дом на наш расчётный счёт. Более детально уточняйте у менеджера.
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                            ...
                            <div class="answer">Да, любой дом можно посмотреть.
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                            ...
                            <div class="answer">У каждого дома свой фиксированный заезд и выезд (указано в карточке товара), сдвинуть сроки реально, нужно обговаривать индивидуально.
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                            ...
                            <div class="answer">Залог берётся администрацией коттеджа только во время заселения в дом и возвращается при выезде из коттеджа. Сумма залога и штраф лист указаны в договоре аренды.
                            </div>
                        </div>
                        <div class="faq__item">
                            <div class="question">
                                Сколько стоят в Ваши услуги?
                            </div>
                            <div class="answer">Мы находимся с цене собственника и получаем комиссию только после вашего отдыха. Мы не накручиваем больше от цены и отдельно нам Вы ничего не платите.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="rent">
            <div class="container">
                <div class="rent-wrap">
                    <a href="" name="cooperation"></a>
                    <h3 class="rent__title">Хотите сдать дом?</h3>
                    <p class="rent__decription">Оставьте заявку и мы свяжемся с вами для уточнения деталей</p>
                    <div class="rent__btn ">
                        <button class="btn-orange btn-orange_rent">Оставить заявку</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mobile__btn">
        <div class="mobile__btn1 mobile__btn1_active">
            <a href="https://domiktut.ru/"><img src="<?php bloginfo('template_url'); ?>/images/svg/Frame (7).svg" alt="">Главная</a>
        </div>
        <div class="mobile__btn1">
            <a href="<?php echo get_category_link($_COOKIE["selected_city"]) ?>"><img src="<?php bloginfo('template_url'); ?>/images/svg/Frame (6).svg" alt="">Каталог</a>
        </div>
        <div class="mobile__btn1">
    ...
    <div class="phone-popup">
        <a href="tel:+79272400954" class="phone-popup__btn btn-three">Позвонить</a>
        <a href="https://t.me/lenar_domiktut" class="phone-popup__btn btn-three telegramm">Написать в Telegram</a>
        <a href="https://wa.me/79272400954?text=Добрый%20день,%20я%20хочу%20получить%20консультацию." class="phone-popup__btn btn-three whatsup">Написать в What’s App</a>
        <button class="phone-popup__btn_white btn-orange call_request-btn">Заявка на подбор</button>
    </div>
    <div class="popup-geo">
        <div class="geo-form">
    ...
    <div class="popup-form-rent">
        <div class="form-popup-rent ">
            <div action="" class="form">
                ...
                <?php echo do_shortcode('[contact-form-7 id="2090" title="Контактная форма от собственника"]'); ?>
            </div>
        </div>
    </div>
    <div class="popup-form-call_request">
        <div class="form-popup-call_request">
            <div action="" class="form">
                ...
                <?php echo do_shortcode('[contact-form-7 id="2088" title="Контактная форма Заявка на подбор"]'); ?>
            </div>
        </div>
    </div>

    <script src="<?php echo get_template_directory_uri(); ?>/filters-btn.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/local-main.js"></script>
    <!-- <script>
